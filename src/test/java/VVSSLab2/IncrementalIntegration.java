...
public class IncrementalIntegration {
    ...
    public void testStudent_success() {
        Student student = new Student(idStudentForGrade, "Pop Ana-Maria", 0, "ana@gmail.com");
        assertEquals(service.addStudent(student), student);
    }

    // Test for assignment success
    @Test
    public void testAssignmentStudent_success() {
        testStudent_success();
        Tema tema = new Tema(idAssignmentForGrade, "description", 5 ,4);
    ...
    // Test for assignment success
    @Test
    public void testNotaAssignmentStudent_success() {
        testAssignmentStudent_success();
